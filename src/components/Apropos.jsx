    ...
    return (
        <div className='apropos'>
            ...
            className='apropos-content'>
                ...
                <p>Suite à une reconversion professionnelle, je me suis naturellement dirigée vers un métier du numérique. En effet, mes appétences ont été le domaine de la santé et le domaine de l'informatique, après avoir réalisé le premier, je concrétise le second. C'est sans regret...</p>
